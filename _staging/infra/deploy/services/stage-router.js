...
const STAGE_MODEL_MAP = {
  ...
  '1.5': {
    ...
    model: 'gpt-5-mini',
    fallbacks: [
      { provider: 'zukijourney', model: 'gpt-4o' }, // Excellent at structured output
      { provider: 'zukijourney', model: 'claude-3.5-haiku' }, // Fast and accurate for normalization
      { provider: 'deepseek', model: 'deepseek-v3' } // Strong reasoning for spec cleanup
    ]
  },
  2: {
    stage: 2,
    ...
    fallbacks: [
      { provider: 'zukijourney', model: 'gpt-4o' }, // Excellent at comprehensive documentation
      { provider: 'deepseek', model: 'deepseek-v3' }, // Strong technical writing capabilities
      { provider: 'zukijourney', model: 'claude-3.5-haiku' } // Good at structured docs
    ]
  },
  3: {
    stage: 3,
    ...
    model: 'deepseek-v3',
    fallbacks: [
      { provider: 'zukijourney', model: 'gpt-4o' }, // Excellent at structured data modeling
      { provider: 'zukijourney', model: 'claude-3.5-haiku' }, // Good at schema design
      { provider: 'github-models', model: 'meta/Llama-4-Scout-17B-16E-Instruct' } // Capable of schema generation
    ]
  },
  '3.5': {
    stage: 3.5,
    ...
    model: 'gpt-5-mini',
    fallbacks: [
      { provider: 'zukijourney', model: 'claude-3.5-haiku' }, // Excellent at validation and consistency checking
      { provider: 'zukijourney', model: 'gpt-4o' }, // Strong analytical capabilities
      { provider: 'deepseek', model: 'deepseek-v3' } // Good reasoning for structural validation
    ]
  },
  4: {
    stage: 4,
    ...
    model: 'gpt-4o',
    fallbacks: [
      { provider: 'deepseek', model: 'deepseek-v3' }, // Excellent at code architecture and structure
      { provider: 'zukijourney', model: 'claude-3.5-haiku' }, // Good at organized file structures
      { provider: 'github-models', model: 'meta/Llama-4-Scout-17B-16E-Instruct' } // Capable of project structure
    ]
  },
  5: {
    stage: 5,
    ...
    fallbacks: [
      { provider: 'zukijourney', model: 'gpt-4o' }, // Excellent at cross-validation and consistency
      { provider: 'deepseek', model: 'deepseek-v3' }, // Strong reasoning for validation
      { provider: 'github-models', model: 'meta/Llama-4-Scout-17B-16E-Instruct' } // Good at validation tasks
    ]
  },
  6: {
    stage: 6,
    ...
    models: [
      {
        ...
        model: 'gpt-5-mini',
        fallbacks: [
          { provider: 'zukijourney', model: 'gpt-4o' }, // Excellent at prompt engineering
          { provider: 'zukijourney', model: 'claude-3.5-haiku' }, // Good at structured prompts
          { provider: 'deepseek', model: 'deepseek-v3' } // Strong at prompt construction
        ]
      },
      {
        role: 'coder',
        ...
        model: 'gemini-3-pro',
        fallbacks: [
          { provider: 'deepseek', model: 'deepseek-v3' }, // Excellent code generation capabilities
          { provider: 'zukijourney', model: 'gpt-4o' }, // Strong coding abilities
          { provider: 'zukijourney', model: 'claude-3.5-haiku' } // Fast and capable coder
        ]
      }
    ],
    fallbacks: []
