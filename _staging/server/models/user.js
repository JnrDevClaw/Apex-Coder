...
class User {
  constructor(data) {
    ...
    // GCP credentials fields
    this.gcpServiceAccountKey = data.gcpServiceAccountKey || null; // Encrypted JSON string
    this.gcpProjectId = data.gcpProjectId || null;
    this.gcpConnectedAt = data.gcpConnectedAt || null;
  }
  ...
  toDynamoItem() {
    return {
      ...
      gcpConnectedAt: this.gcpConnectedAt
    };
  }
  ...
  async update(updates) {
    try {
      const allowedUpdates = [
        ...
        'gcpServiceAccountKey', 'gcpProjectId', 'gcpConnectedAt'
      ];
  ...
  static fromDynamoItem(item) {
    return new User({
      ...
      gcpServiceAccountKey: item.gcpServiceAccountKey,
      gcpProjectId: item.gcpProjectId,
      gcpConnectedAt: item.gcpConnectedAt
    });
  }
}
